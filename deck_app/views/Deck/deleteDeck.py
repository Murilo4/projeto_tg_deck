...
#                             target=delete_flashcard,
#                             args=(deck_flashcard.flashcard_id,
#                                   deck_flashcard.id,
#                                   user_id)
#                         )
...
#                     # Excluir flashcards associados ao deck para o usuário
#                     deck_flashcard_ids = [
#                         deck_flashcard.id for deck_flashcard in deck_flashcards]
#                     user_flashcards = UserFlashCard.objects.filter(
#                         user_id=user_id,
#                         deck_flashcard_id__in=deck_flashcard_ids
#                     )
...
#         target=delete_translation, args=(deck_flashcard,)))
#     threads.append(threading.Thread(
#         target=delete_pronunciation, args=(deck_flashcard,)))
#     threads.append(threading.Thread(
#         target=delete_examples, args=(deck_flashcard,)))
#     threads.append(threading.Thread(
#         target=delete_user_flashcard, args=(deck_flashcard, user_id)))
