...
from .views.deck_management import add_standard_deck_to_user
...
urlpatterns = [
    ...
    path('get-deck/<int:deck_id>',
         get_deck, name='get_deck'),
    path('get-standard-decks/',
         get_standard_decks, name='get_standard_decks'),
    path('add-standard-deck-to-user/',
         add_standard_deck_to_user, name='add_standard_deck_to_user'),
]
